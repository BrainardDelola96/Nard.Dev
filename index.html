		...
		<div class="bnr_con">
			...
			<div class="slider">
				<ul class="rslides">
					...
					<li><figure><img src="images/slider/bn2.png" alt="____________________"></figure></li>
					<li><figure><img src="images/slider/bn3.png" alt="____________________"></figure></li>
				</ul>
				<div class="box_skitter box_skitter_large">
					<ul>
						<li><figure><img src="images/slider/bn1.png" alt="____________________" class="fade"></figure></li>
						<li><figure><img src="images/slider/bn2.png" alt="____________________" class="fade"></figure></li>
						<li><figure><img src="images/slider/bn3.png" alt="____________________" class="fade"></figure></li>
	...
	<div class="wrapper">
		<div class="btm1_con">
			...
			<div class="btm1_boxes">
				...
				<section>
					<figure><img src="images/icons/btm1-icon1.png" alt="HTML"></figure>
					<div class="bm1_info">
						<h2>HTML</h2>
						<p>Web Development</p>
					</div>
				...
				<section>
					<figure><img src="images/icons/btm1-icon2.png" alt="CSS"></figure>
					<div class="bm1_info">
						<h2>CSS</h2>
						<p>Web Development</p>
					</div>
				...
				<section>
					<figure><img src="images/icons/btm1-icon3.png" alt="Javascript"></figure>
					<div class="bm1_info">
						<h2>JavaScript</h2>
						<p>Web Development</p>
					</div>
			...
			<div class="btm1_boxes">
				...
				<section>
					<figure><img src="images/icons/btm1-icon5.png" alt="Laravel"></figure>
					<div class="bm1_info">
						<h2>Laravel</h2>
						<p>Backend</p>
					</div>
				...
				<section>
					<figure><img src="images/icons/btm1-icon8.png" alt="Java"></figure>
					<div class="bm1_info">
						<h2>Java</h2>
						<p>Backend</p>
					</div>
				...
				<section>
					<figure><img src="images/icons/btm1-icon9.png" alt="My Sql"></figure>
					<div class="bm1_info">
						<h2>My Sql</h2>
						<p>Database</p>
					</div>
